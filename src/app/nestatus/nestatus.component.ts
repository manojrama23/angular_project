...
import { NegrowstatusService } from '../services/negrowstatus.service';
import * as jsPDF from 'jspdf';
@Component({
  selector: 'app-nestatus',
  templateUrl: './nestatus.component.html',
  styleUrls: ['./nestatus.component.scss'],
  providers: [NegrowstatusService]
})
export class NestatusComponent implements OnInit {
  ...
  scriptcompleted = 0;
    ...
    constructor(
      ...
      private negrowService: NegrowstatusService,
   ...
   */
    ...
    */
    ...
    showResultLog(content, key) {
      ...
      this.showLoader = true;
      this.negrowService.showResultLogs(this.sharedService.createServiceToken(), key.id)
        .subscribe(
          data => {
            setTimeout(() => {
              let jsonStatue = data.json();
