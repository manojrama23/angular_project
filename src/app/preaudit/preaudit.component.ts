...
import { AuditpreService } from '../services/auditpre.service';
...
@Component({
  selector: 'app-preaudit',
  templateUrl: './preaudit.component.html',
  styleUrls: ['./preaudit.component.scss'],
  providers: [AuditpreService]
})
export class PreauditComponent implements OnInit {
  ...
  constructor(
      ...
      private auditService: AuditpreService,
