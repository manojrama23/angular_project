...
import { AuditpostService } from '../services/auditpost.service';
...
@Component({
    selector: 'app-auditpost',
    templateUrl: './auditpost.component.html',
    styleUrls: ['./auditpost.component.scss'],
    providers: [AuditpostService]
})

export class AuditpostComponent implements OnInit {
    ...
    constructor(
        ...
        private auditService: AuditpostService,
  ...
  resetrunTestForm() {
    ...
    getRunTest() {
        ...
        this.auditService.getRunTest(this.searchStatus, this.searchCriteria, this.paginationDetails, this.sharedService.createServiceToken(), this.commissionType, this.showMySites).subscribe(
            data => {
    ...
    getSearchCriteria(event) {
        if (!event.target.classList.contains('hiddenSearch')) {
            let currentForm = event.target.parentNode.parentNode.parentNode,
                searchCrtra = {
                    "fromDate": currentForm.querySelector("#fromDate").value,
                    "toDate": currentForm.querySelector("#toDate").value,
                    "testName": currentForm.querySelector("#searchName").value,
                    "lsmVersion": currentForm.querySelector("#searchVersion").value,
                    "lsmName": currentForm.querySelector("#searchSMName").value,                            
                    "ciqName": currentForm.querySelector("#searchCiqName").value,
                    "neName": currentForm.querySelector("#searchNeName").value,
                    "userName": currentForm.querySelector("#searchUserName").value
                };
    ...
    getNEList(selectedCiqName, updateSessionStorage = false){ 
        ...
        this.auditService.getNeListData(selectedCiqName.ciqFileName, this.sharedService.createServiceToken() )
            .subscribe(
                data => {
                    setTimeout(() => { 
                      let jsonStatue = data.json();                      
     ...
     /*  getUseCaseList() {
       ...
       this.showLoader = true;
        setTimeout(() => {
            ...
            this.auditService.getUseCaseListData(this.ciqDetails.ciqFileName, neDetails, this.sharedService.createServiceToken())
                .subscribe(
                    data => {
                        setTimeout(() => {
                            let jsonStatue = data.json();
    ...
    submitRunTestForm(event,requestType) {
        ...
        setTimeout(() => {
            if (this.isValidForm(event)) {
                ...
                this.auditService.uploadRunTestDetails(this.sharedService.createServiceToken(), runTestFormDetails,this.commissionType,requestType, this.isRETUseCaseSelected, this.isRETUseCaseSelected ? formdata : null)
                    .subscribe(
                        data => {
                            let jsonStatue = data.json();
    ...
    onChangeNEs(event: any) {
        ...
        /* if(this.selectedNEItems.length == 1) {
            this.showLoader = true;
            this.auditService.getNeConfigDetails(this.sharedService.createServiceToken(), this.ciqDetails, this.selectedNEItems)
                .subscribe(
                    data => {
                        setTimeout(() => {
                            let jsonStatue = data.json();
    ...
    getMigUseCases() {
        ...
        if (this.ciqDetails && this.selectedNEItems && this.selectedNEItems.length > 0) {
            ...
            this.showLoader = true;
            this.auditService.getMigUseCases(this.ciqDetails, selectedNEs, this.sharedService.createServiceToken(), this.commissionType)
                .subscribe(
                    data => {
                        setTimeout(() => {
                            let jsonStatue = data.json();
    ...
    updateUseCaseSelection(currSelectedItem) {
        if(currSelectedItem && (currSelectedItem["item_text"].indexOf("vDUInstantiation") >= 0)) {
            for(let useCaseItem of this.dropdownList) {
                if(useCaseItem["item_text"].indexOf("mmuAuditReport") >= 0) {
                    if (!this.checkUseCaseAvl("mmuAuditReport", this.selectedItems)) {
                        let selectedItems = this.selectedItems.map((item) => item);
        ...
        if(this.programName == 'VZN-4G-USM-LIVE' && currSelectedItem && (currSelectedItem["item_text"].toLowerCase().indexOf("cbrs") >= 0)) {
            for(let useCaseItem of this.dropdownList) {
                if ((useCaseItem["item_text"].toLowerCase().indexOf("fcc") >= 0) && !this.checkUseCaseAvl(useCaseItem["item_text"], this.selectedItems)) {
                    let selectedItems = this.selectedItems.map((item) => item);
                    selectedItems.push(useCaseItem);
                    this.selectedItems = selectedItems;
                }
        ...
        if(this.isCBRSTypeSelected && this.programName == 'VZN-4G-USM-LIVE' && currSelectedItem && (currSelectedItem["item_text"].toLowerCase().indexOf("healthcheck") >= 0)) {
            for(let useCaseItem of this.dropdownList) {
                if ((useCaseItem["item_text"].toLowerCase().indexOf("fcc") >= 0 || useCaseItem["item_text"].toLowerCase().indexOf("cbrs") >= 0 || useCaseItem["item_text"].toLowerCase().indexOf("healthcheck") >= 0) && !this.checkUseCaseAvl(useCaseItem["item_text"], this.selectedItems)) {
                    let selectedItems = this.selectedItems.map((item) => item);
                    selectedItems.push(useCaseItem);
                    this.selectedItems = selectedItems;
                }
    ...
    */
    deleteRow(event, deleteModal, rowId) {
        ...
        if (deleteState.className != "deleteRowDisabled") {
            ...
            this.modalService.open(deleteModal, {
                ...
                this.auditService.deleteRunTestData(rowId, this.sharedService.createServiceToken(), this.commissionType)
                    .subscribe(
                        data => {
                            let jsonStatue = data.json();
                            this.showLoader = false;
    ...
    viewResult(content, key) {
        ...
        this.auditService.viewTestResult(this.sharedService.createServiceToken(), key.id,key.lsmName,key.neName)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
                    if (jsonStatue.sessionId == "408" || jsonStatue.status == "Invalid User") {
                ...
                error => {
                    //Please Comment while checkIn
                     ...
                     /* setTimeout(() => {
                        ...
                        let jsonStatue = {"SMName":"Rochester","programName":"VZN-4G-USM-LIVE","failedScript":false,"NEName":"070356_BUFFALO_WATERFRONT","useCaseResult":[{"useCaseName":"27th July UC","useCaseId":8867,"script_status":[{"scriptId":4685,"scriptName":"oRAN_USMAUDIT_VER_9","scriptExeSeq":128,"XML_Rules":[{"ruleDefinition":"XmlRuleName : curl, RootName : rpc-reply, SubrootName : , ElementName : curl, ElementValue : error, Operator : CONTAINS, Status : Pass","ruleName":"curl","status":"NO DATA"},{"ruleDefinition":"XmlRuleName : ENBPLMN-INFO, RootName : enb-function, SubrootName : , ElementName : plmn-index, ElementValue :   {    \"ruleData\": {      \"condition\": \"or\",      \"outputFormate\": \"String\",      \"results\": \"0|1\",      \"multipleColunms\": null    }  }, Operator : TEMPLATE, ElementName : mnc, ElementValue : 480, Operator : ==, ElementName : mcc, ElementValue : 311, Operator : ==, Status : Pass","ruleName":"ENBPLMN-INFO","status":"NO DATA"},{"ruleDefinition":"XmlRuleName : CELL-SEL, RootName : enb-function, SubrootName : , ElementName : cell-num, ElementValue : 1, Operator : ==, ElementName : rel9-selection-info-usage, ElementValue : disable, Operator : CONTAINS, ElementName : q-rx-lev-min-offset, ElementValue : 4, Operator : ==, ElementName : q-rx-lev-min, ElementValue : -60, Operator : CONTAINS, ElementName : p-max, ElementValue : 23, Operator : ==, ElementName : q-rx-lev-min-offset-usage, ElementValue : enable, Operator : CONTAINS, ElementName : p-max-usage, ElementValue : disable, Operator : CONTAINS, ElementName : cell-num, ElementValue : 1, Operator : ==, Status : Pass","ruleName":"CELL-SEL","status":"NO DATA"}]}]}],"sessionId":"3c3d22f4","serviceToken":"90171","isProcessCompleted":true,"status":"SUCCESS"};
    ...
    reRun(key) {
        ...
        this.auditService.reRunTest(this.sharedService.createServiceToken(), key.id, key.useCaseDetails)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
                    if (jsonStatue.sessionId == "408" || jsonStatue.status == "Invalid User") {
    ...
    showCheckList(content, key) {
        ...
        this.showLoader = true;
        this.auditService.getChecklistSheetDetails(this.sharedService.createServiceToken(), this.rowData)
          .subscribe(
            data => {
              setTimeout(() => {
                let jsonStatue = data.json();            
       ...
       */
        ...
        getAllChecklistDetails(sheetName, index, content){
            ...
            this.showLoader = true;
            this.auditService.getDeatilsByChecklist(this.sharedService.createServiceToken(), this.paginationDetails, this.rowData)
                .subscribe(
                  data => {
                      setTimeout(() => {
                        let jsonStatue = data.json();
    ...
    saveCheckList(c) {
        this.auditService.updateCheckList(this.sharedService.createServiceToken(), this.rowData, this.checklistTableData)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
                    if (jsonStatue.sessionId == "408" || jsonStatue.status == "Invalid User") {
    ...
    getScriptOutput(event) {
        ...
        this.auditService.scriptOutput(this.sharedService.createServiceToken(), this.testId, useCaseName, useCaseId, scriptName, scriptId)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
                    if (jsonStatue.sessionId == "408" || jsonStatue.status == "Invalid User") {
    ...
    showRunningLog(content, key) {
        ...
        this.showLoader = true;
        this.auditService.getRunningLogs(this.sharedService.createServiceToken(), key.id)
            .subscribe(
                data => {
                    setTimeout(() => {
                        let jsonStatue = data.json();
    ...
    updateRunningLog() {
        ...
        this.auditService.getRunningLogs(this.sharedService.createServiceToken(), this.rowData.id)
            .subscribe(
                data => {
                    setTimeout(() => {
                        let jsonStatue = data.json();
    ...
    downloadLogs(key) {
        ...
        this.auditService.downloadFile(this.sharedService.createServiceToken(), key)
            .subscribe(
                data => {
      ...
      downloadResult(fileName,filePath) {
        ...
        this.auditService.downloadResultFile(fileName,filePath,this.sharedService.createServiceToken())
        .subscribe(
            data => {
                let blob = new Blob([data["_body"]], {
    ...
    /* downLoadResultFile(key) {
        this.auditService.downLoadResultFile(this.sharedService.createServiceToken(), key)
            .subscribe(
                data => {
                ...
                error => {
                    ...
                    let blob = new Blob(["<h1>Hello, world!</h1>"], { 
                        type: "text/html" 
                    });
      ...
      viewCheckConLog(content) {
        this.showLoader = true;
        this.auditService.getConnectionLog(this.sharedService.createServiceToken())
            .subscribe(
                data => {
                    setTimeout(() => {
                        let jsonStatue = data.json();
    ...
    */
    ...
    connect(event) {
        ...
        setTimeout(() => {
            if (this.isValidForm(event)) {
                ...
                this.auditService.uploadRunTestDetails(this.sharedService.createServiceToken(), this.runTestDetails, this.commissionType, this.requestType, this.isRETUseCaseSelected, this.isRETUseCaseSelected ? formdata : null)
                    .subscribe(
                        data => {
                            let jsonStatue = data.json();
    ...
    showListOfSCriptFiles(popover, key) {
        ...
        this.showInnerLoader = true;
        this.auditService.getChecklistScriptDetails(this.sharedService.createServiceToken(), this.rowData, key.stepIndex)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
                    if (jsonStatue.sessionId == "408" || jsonStatue.status == "Invalid User") {
                ...
                error => {
                    ...
                    /* setTimeout(() => {
                        ...
                        // let jsonStatue = JSON.parse('{"sessionId":"7e088256","serviceToken":"81749","status":"SUCCESS","scriptList":[{"id":2,"scriptName":"Script1","scriptExeSeq":4},{"id":1,"scriptName":"Script2 with space","scriptExeSeq":7},{"id":3,"scriptName":"Script2","scriptExeSeq":3},{"id":11,"scriptName":"Script no space","scriptExeSeq":1}],"reason":""}');
                        let jsonStatue;
                        this.showInnerLoader = false;
    ...
    copyFunction() {
      ...
      downloadGeneratedScripts(testName, filePath) {
        ...
        this.auditService.downloadGenScripts(filePath,this.sharedService.createServiceToken())
        .subscribe(
            data => {
                let blob = new Blob([data["_body"]], {
                    type: "application/octet-stream"
      ...
      showAuditPassFail() {
        ...
        this.auditService.getAuditPassFailReport(this.auditIssueKey, this.sharedService.createServiceToken())
                    .subscribe(
                        data => {
                            let jsonStatue = data.json();
                            if (jsonStatue.sessionId == "408" || jsonStatue.status == "Invalid User") {
      ...
      showAuditIssues() {
        this.showInnerLoader = true;
        this.auditService.getAuditSummaryReport(this.auditIssueKey, this.sharedService.createServiceToken(),)
                    .subscribe(
                        data => {
                            let jsonStatue = data.json();
                            if (jsonStatue.sessionId == "408" || jsonStatue.status == "Invalid User") {
                                ...
                                if (this.sharedService.isvalidServiceToken(parseInt(data.json().serviceToken, 10)) || data.json().sessionId == "408") {
                                    if (jsonStatue.status == "SUCCESS") {
                                        ...
                                        this.postAuditIssues = jsonStatue.postAuditIssues;
                                    } else {
                                        this.showInnerLoader = false;
                                        this.displayModel(jsonStatue.reason, "failureIcon");
                                    }
                        ...
                        error => {
                            ...
                            /* setTimeout(() => {
                                ...
                                let jsonStatue = {"neId":"180872","sessionId":"f60ea9cf","neName":"180872_FAWN_MEADOWS_MS","serviceToken":"58603","postAuditIssues":[{"referenceMOP":"https://test.com","test":"Verify all the Firmware Release","testName":"CHECK FIRMWARE RELEASE TEST","yangCommand":"retrieve-processor-firmware-inventory","auditIssue":"firmware-name : rom_os.lcc_m.07 package-version : 21.A.0 patch-version : 00\nfirmware-name : rom_kernel.lmd.01 package-version : 20.A.0 patch-version : 00\nfirmware-name : rom_kernel.lmd.01 package-version : 20.A.0 patch-version : 00\nfirmware-name : rom_rfs_raw.lmd.01 package-version : 7.0.0 patch-version : 09\n","expectedResult":"[THIS NEEDS TO BE REVISED FOR EVERY NEW RELEASE]\nfirmware-name\npackage-version\npatch-version)","actionItem":"Do a hard reboot on eNB to download the release from CFM.","remarks":"test kjlkj ljlkjl lkjlj","errorCode":"LS6_MMU_Ping_Fail_1"},{"test":"Verify all the Software release","testName":"SOFTWARE VERSION TEST","yangCommand":"retrieve-active-software","auditIssue":"software-unit-name: dbm package-version : 21.A.0 release-version : r-01 patch-version : 03\nsoftware-unit-name: ipscm package-version : 21.A.0 release-version : r-0106 patch-version : 03\nsoftware-unit-name: ciagent package-version : 21.C.0 release-version : r-01 patch-version : 03\nsoftware-unit-name: scm package-version : 21.A.0 release-version : r-01 patch-version : 03\nsoftware-unit-name: twamp package-version : 21.A.0 release-version : r-01 patch-version : 03\n","expectedResult":"[FOR ALL THE software-unit-name]\npackage-version : <CIQ>\nrelease-version: <CIQ>","actionItem":"Do a hard reboot on eNB to download the release from CFM.","remarks":"","errorCode":"LS6_MMU_Ping_Fail_2"}],"status":"SUCCESS","reason":""};
      ...
      downloadBulkSummaryReport() {
        ...
        this.showLoader = true;
        this.auditService.downloadBulkAuditReport(this.sharedService.createServiceToken(), this.paginationDetails, this.searchCriteria, this.searchStatus, true)
        .subscribe(
            data => {
                this.showLoader = false;
                let blob = new Blob([data["_body"]], {
      ...
      downloadBulkAuditReport() {
        document.getElementById('downloadBulkSearchButton').click();
        this.showLoader = true;
        this.auditService.downloadBulkAuditReport(this.sharedService.createServiceToken(), this.paginationDetails, this.searchCriteria, this.searchStatus, false)
        .subscribe(
            data => {
                this.showLoader = false;
                let blob = new Blob([data["_body"]], {
      ...
      downloadAuditPassFailReport() {
        this.showInnerLoader = true;
        this.auditService.downloadAuditPassFailReport(this.sharedService.createServiceToken(), this.auditIssueKey, this.auditIssueNEInfo)
        .subscribe(
            data => {
                let blob = new Blob([data["_body"]], {
                    type: "application/octet-stream"
      ...
      downloadAuditReport() {
        this.showInnerLoader = true;
        this.auditService.downloadAuditSummaryReport(this.sharedService.createServiceToken(), this.postAuditIssues, this.auditIssueNEInfo)
        .subscribe(
            data => {
                let blob = new Blob([data["_body"]], {
                    type: "application/octet-stream"
                ...
                let newFileName = this.auditIssueNEInfo.neName + "_AuditSummaryReport_" + this.sharedService.getCurrentTimestamp() + ".xlsx";//AuditSummaryReport_"neName".xlsx
    ...
    */
    ...
    //   this.getNeConfigDetails();
        ...
        if (neDetails && neDetails.length > 0) {
            this.showLoader = true;
            this.auditService.getRadioUnitListData(this.ciqDetails.ciqFileName, neDetails, this.sharedService.createServiceToken())
                .subscribe(
                    data => {
                        setTimeout(() => {
                            let jsonStatue = data.json();
    ...
    viewOVFailureMessagae(failureErrorModal, key) {
        ...
        this.auditService.viewOVFailureMessage(this.sharedService.createServiceToken(), key.id, key.lsmName, key.neName, key.useCase)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
    ...
    ovRetry() {
        ...
        this.auditService.retryMilestoneUpdate(this.sharedService.createServiceToken(), this.ovRetryData, this.milestoneResult)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
    ...
    ovRetryFailedMilestone(failedMilestone: any) {
        ...
        this.auditService.retryFailedMilestoneUpdate(this.sharedService.createServiceToken(), this.ovRetryData, failedMilestone)
            .subscribe(
                data => {
                    let jsonStatue = data.json();
